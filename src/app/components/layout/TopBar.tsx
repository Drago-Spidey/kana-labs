    ...
    <div className="bg-klTbBg flex items-center justify-between p-3 h-[80px] z-[1] rounded-b-xl sticky top-0">
      ...
      {page !== "Swap" && (
        <div className="flex flex-col py-4 px-6">
          ...
          <img src="/kana-labs/assets/EthosX.svg" alt="" />
        </div>
      )}
      ...
      {page !== "Swap" && (
        ...
        <div className="bg-klBtnBg text-klFC px-6 py-2 gap-3 flex rounded-2xl items-center">
          <div className="f-1 flex gap-2 items-center">
            <div className="icon">
              <img src="/kana-labs/assets/coins.svg" alt="Coins Icon" />
            </div>
            <div className="t">
          ...
          <div className="f-2 flex gap-2 items-center">
            <div className="icon">
              <img src="/kana-labs/assets/zap.svg" alt="Zap Icon" />
            </div>
            <div className="t">
        ...
        <div className="bg-klBtnBg px-6 py-2 gap-2 flex rounded-2xl items-center">
          <img src="/kana-labs/assets/fox.png" alt="Fox Icon" className="h-6 w-6" />
          <p className="font-extrabold text-klc max-w-[130px] overflow-hidden text-ellipsis">
            0xwalletaddresxyz
          </p>
          <img
            src="/kana-labs/assets/copy.svg"
            alt="Copy Icon"
            className="p-1 hover:cursor-pointer"
          />
          <img
            src="/kana-labs/assets/power-off.svg"
            alt="Power Off Icon"
            className="p-1 hover:cursor-pointer"
          />
        </div>
